...
namespace Editing
{
    public partial class Form1 : SfForm
    {
        ...
        private void BindObjectRelationalData()
        {
            ...
            treeViewAdv1.ChildMember = "Continents\\Country\\State";
        ...
        private void menuItem1_Click(object sender, System.EventArgs e)
        {
            ...
            if (comboBox1.SelectedIndex == 0)
            {
                dt.Rows.Add("Rajasthan", "10" + count.ToString(), "2", "Sivagiri", false);
            }
            else if (comboBox1.SelectedIndex == 1)
            {
                if (gridGroupingControl1.DataSource == FolderTable)
                {
                    dt.Rows.Add("Folder 100" + count.ToString(), "New Folder 10", "10", "1010");
                }
                else if (gridGroupingControl1.DataSource == SubFolder1)
                {
                    dt.Rows.Add("Level 1 Sub Folder 1" + count.ToString(), "Level 1 New Sub Folder 1", "1000", count.ToString(), true);
                }
                else if (gridGroupingControl1.DataSource == SubFolder2)
                {
                    dt.Rows.Add("Level 2 Sub Folder 1" + count.ToString(), "Level 2 New Sub Folder 1", "2000", count.ToString());
                }
                else
                {
                    dt.Rows.Add("Level 3 Sub Folder 1" + count.ToString(), "Level 3 New Sub Folder", "3000", count.ToString(), true);
                }
