...
# endregion
        ...
        private void comboBoxAdv1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.comboBoxAdv1.SelectedItem.ToString().Equals("Office2016DarkGray"))
            {
                ...
                this.dwNotes2.BackColor = ColorTranslator.FromHtml("#666666");
                this.dwNotes2.ForeColor = ColorTranslator.FromHtml("#f0f0f0");
            ...
            else if (this.comboBoxAdv1.SelectedItem.ToString().Equals("Office2016Black"))
            {
                ...
                this.dwNotes2.BackColor = ColorTranslator.FromHtml("#262626");
                this.dwNotes2.ForeColor = ColorTranslator.FromHtml("#ffffff");
            ...
            else if (this.comboBoxAdv1.SelectedItem.ToString().Equals("Office2016Colorful"))
            {
                ...
                this.dwNotes2.BackColor = ColorTranslator.FromHtml("#ffffff");
                this.dwNotes2.ForeColor = ColorTranslator.FromHtml("#262626");
