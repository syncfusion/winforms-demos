...
namespace MultiColumnComboBox
{
    ...
    public partial class Filtering : SfForm
    {
        ...
        public Filtering()
        {
            ...
            this.SizeChanged += Filtering_SizeChanged;
            this.richTextBox1.Multiline = true;
            this.richTextBox1.ReadOnly = true;
            this.richTextBox1.Dock = DockStyle.Fill;

            //Sizing
            this.multiColumnComboBox1.Location = new Point(((this.gradientPanel3.Width - this.multiColumnComboBox1.Width) / 2), ((this.gradientPanel3.Height - this.multiColumnComboBox1.Height) / 2));
        ...
        /// <summary>
        /// Event triggered while Form's size changed
        /// </summary>
        /// <param name="sender">Sender of this event</param>
        /// <param name="e">Event parameter</param>
        private void Filtering_SizeChanged(object sender, EventArgs e)
        {
            this.multiColumnComboBox1.Location = new Point(((this.gradientPanel3.Width - this.multiColumnComboBox1.Width) / 2), ((this.gradientPanel3.Height - this.multiColumnComboBox1.Height) / 2));
        }
