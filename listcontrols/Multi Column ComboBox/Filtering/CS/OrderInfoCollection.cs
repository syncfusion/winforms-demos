...
{
    /// <summary>
    /// Summary description for OrderInfoCollection.
    /// </summary>
    class OrderInfoCollection : IDisposable
    {
        ...
        /// Dispose the values
        /// </summary>
        /// <param name="isdisposable">Tells whether it is disposable or not</param>
    ...
    /// <summary>
    /// Class used to get the OrderInfo collection values
    /// </summary>
    class OrderInfoRepository
    {
        ...
        /// </summary>
        /// <param name="i">Integer value based on it ID will be calculated</param>
        ...
        /// <summary>
        /// Contains the Ship country values
        /// </summary>
