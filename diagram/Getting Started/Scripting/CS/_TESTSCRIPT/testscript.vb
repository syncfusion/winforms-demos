        ...
        For Each n in e.Elements
            If TypeOf n Is FilledPath Then
                ...
                If e.ChangeType = Syncfusion.Windows.Forms.Diagram.CollectionExChangeType.Insert Then
                    ...
                    MessageBoxAdv.Show(String.Concat(n.Name, " node added"), "Syncfusion Essential Diagram", MessageBoxButtons.OK, MessageBoxIcon.Information)
                ElseIf e.ChangeType = Syncfusion.Windows.Forms.Diagram.CollectionExChangeType.Remove Then
                    MessageBoxAdv.Office2007Theme = Office2007Theme.Blue
                    MessageBoxAdv.Show(String.Concat(n.Name, " node Removed"), "Go Syncfusion!!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                End If
            End If
        Next
  End Sub
