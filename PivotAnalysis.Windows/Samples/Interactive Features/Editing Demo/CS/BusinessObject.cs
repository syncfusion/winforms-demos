...
namespace EditingDemo
{
    ...
    class BusinessObjectCollection : List<BusinessObject>
    {
        public static BusinessObjectCollection GetList(int count)
        {
            ...
            List<string> Fruits = new List<string>(new[] { "cherry", "mango", "orange", "grape", "Persimmon", "plum", "fig", "apple", "lime", "gooseberry", "strawberry", "rasberry" });
            List<string> Colors = new List<string>(new[] { "red", "green", "blue", "yellow", "orange", "pink", "crimson", "almond", "white", "black", "aqua", "beige" });
