...
{
    public partial class CallCenterDashboard : MetroForm
    {
        #region Constants
#if NETCORE
        ...
        # region Call Center Dashboard in Spreadsheet
        /// <summary>
        /// Creates spreadsheet
        /// </summary>
...
#if !NETCORE
                inputTemplate = GetFullTemplatePath("CallCenterTemplate.xlsx");
#else
            inputTemplate = GetFullTemplatePath("CallCenterTemplate.xlsx");
#endif
                IWorkbook workbook = application.Workbooks.Open(inputTemplate);
                #endregion
