...
namespace FindAndHighlight
{
    public class Form1 : MetroForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.buttonHighlight.Location = new System.Drawing.Point(285, 300);
            ...
            this.buttonHighlight.Size = new System.Drawing.Size(108, 23);
        ...
        private void buttonHighlight_Click(object sender, System.EventArgs e)
        {
            ...
            string input = "";
#if !NETCore
            input = Path.GetFullPath(@"..\..\..\..\..\..\common\Data\Presentation\Input Template.pptx");
#else
            input = Path.GetFullPath(@"..\..\..\..\..\..\..\common\Data\Presentation\Input Template.pptx");
#endif
