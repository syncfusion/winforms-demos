...
write(toString(pmmlFile),file="D:/PREDICTIVE_729_Generating_pmml/Multinomial Regression/Titanic/Model/Titanic.pmml")
saveXML(pmmlFile,file="D:/PREDICTIVE_729_Generating_pmml/Multinomial Regression/Titanic/Model/Titanic.pmml")
...
write.csv(result,"D:/PREDICTIVE_729_Generating_pmml/Multinomial Regression/Titanic/Model/ROutput.csv",quote=F)
