...
namespace EssentialDocIOSamples
{
    ...
    public class Form1 : MetroForm
    {
        ...
        private void button1_Click(object sender, System.EventArgs e)
        {
            ...
            {
#if NETCORE
                string datapath = @"..\..\..\..\..\..\..\..\Common\Data\DocIO\MacroTemplate.dotm";
#else
                string datapath = @"..\..\..\..\..\..\..\Common\Data\DocIO\MacroTemplate.dotm";
#endif
...
#if NETCORE
            System.Diagnostics.Process process = new System.Diagnostics.Process();
            process.StartInfo = new System.Diagnostics.ProcessStartInfo(@"..\..\..\..\..\..\..\..\Common\Data\DocIO\MacroTemplate.dotm") { UseShellExecute = true };
            process.Start();
#else
