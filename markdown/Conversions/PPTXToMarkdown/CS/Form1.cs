...
namespace PPTXToMarkdown
{
    public partial class Form1 : MetroForm 
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Click the below button to convert the selected PowerPoint presentation into a Markdown file. At " +
    "the end of the process, an option will be provided to view the generated file.";
            ...
            try
            {
                if (this.textBox1.Text != String.Empty && fullPath != string.Empty)
                {
                    ...
                    if (File.Exists(fullPath))
                    {
                        ...
                        presentation.Save(outputFileName + ".md");
                ...
                {
                    MessageBoxAdv.Show("Browse a PowerPoint Presentation and click the button to convert as a Markdown.");
                }
            }
            catch (Exception Ex)
            {
        ...
        {
            this.textBox1.Text = "PPTXToMarkdown.pptx";
            fullPath = Application.StartupPath + @"..\..\..\..\..\..\..\common\Data\Markdown\PPTXToMarkdown.pptx";
        }
        #endregion
    }
}
