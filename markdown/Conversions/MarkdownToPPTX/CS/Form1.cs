...
namespace MarkdownToPPTX
{
    ...
    {		
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Click the below button to convert the selected Markdown into a PowerPoint presentation. At " +
    "the end of the process, an option will be provided to view the generated file.";
            ...
            this.button1.Text = "Convert to PPTX";
            ...
            try
            {
                if (this.textBox1.Text != String.Empty && fullPath != string.Empty)
                {
                    ...
                    if (File.Exists(fullPath))
                    {
                        ...
                        presentation.Save(outputFileName + ".pptx");
                        //Message box confirmation to view the created document.
                        if (MessageBoxAdv.Show("Do you want to view the PPTX file?", "File has been created", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                        {
                            try
                            {
#if NETCore
                                System.Diagnostics.Process process = new System.Diagnostics.Process();
                                process.StartInfo = new System.Diagnostics.ProcessStartInfo(outputFileName +".pptx") { UseShellExecute = true };
                                process.Start();
#else                       
                                System.Diagnostics.Process.Start(outputFileName + ".pptx");
#endif
                                //Exit
                                this.Close();
                            }
                ...
                {
                    MessageBoxAdv.Show("Browse a Markdown document and click the button to convert as a PPTX.");
                }
            }
            catch (Exception Ex)
            {
        ...
        {
            this.textBox1.Text = "MarkdownToPPTX.md";
            fullPath = Application.StartupPath + @"..\..\..\..\..\..\..\common\Data\Markdown\MarkdownToPPTX.md";
        }
        #endregion
    }
}
