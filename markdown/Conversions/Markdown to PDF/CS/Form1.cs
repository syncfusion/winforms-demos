...
namespace Markdown_to_PDF
{
    ...
    public class Form1 : MetroForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Click the below button to convert the selected Markdown into a PDF document. At " +
    "the end of the process, an option will be provided to view the generated file.";
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBoxAdv.Show("Browse a Markdown document and click the button to convert as a PDF.");
                }
            }
            catch (Exception Ex)
            {
