    ...
    public class WorksheetProtection : MetroForm
    {
        ...
        private void btnWorksheetLock_Click(object sender, System.EventArgs e)
        {
                ...
                == DialogResult.Yes)
            {
                ...
                process.StartInfo = new System.Diagnostics.ProcessStartInfo("ProtectedSheet.xls")
                {
                    UseShellExecute = true
                };
                process.Start();
#else
                Process.Start("ProtectedSheet.xls");
#endif
            }
            #endregion
        }
...
#if NETCORE
                System.Diagnostics.Process process = new System.Diagnostics.Process();
                process.StartInfo = new System.Diagnostics.ProcessStartInfo("UnlockedWorksheet.xls")
                {
                    UseShellExecute = true
                };
                process.Start();
#else
                Process.Start("UnlockedWorksheet.xls");
#endif
                //Exit
                this.Close();
            }
