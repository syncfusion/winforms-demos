    ...
    public class Form1 : MetroForm
    {
        ...
        private void button1_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                picture.WidthScale = DpiAware.LogicalToDeviceUnits(79);
                picture.HeightScale = DpiAware.LogicalToDeviceUnits(79);
                ...
                picture.WidthScale = DpiAware.LogicalToDeviceUnits(75);
                picture.HeightScale = DpiAware.LogicalToDeviceUnits(75);
                ...
                picture.WidthScale = DpiAware.LogicalToDeviceUnits(92);
                picture.HeightScale = DpiAware.LogicalToDeviceUnits(92);
