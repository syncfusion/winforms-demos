...
namespace FilteringDemo
{
    public partial class Form1 : SfForm
    {
        ...
        public Form1()
        {
            ...
            this.textBox1.Text = "Filter will be applied to all the nodes in MultiColumnTreeView";
        ...
        private void ComboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                this.textBox1.Text = string.Empty;
                this.textBox1.Text = "Filter will be applied to root nodes only in MultiColumnTreeView";
                this.multiColumnTreeView1.FilterLevel = FilterLevel.Root;
            }
            else if (this.comboBox1.SelectedIndex == 2)
            {
                this.textBox1.Text = string.Empty;
                this.textBox1.Text = "Filter will be applied to all the nodes. If a node matches the filter condition, its all ancestors will be displayed even though the parent node does not match the filter condition.";
